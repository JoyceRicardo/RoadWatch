...
export type FhevmRelayerStatusType = "sdk-loading" | "sdk-loaded" | "sdk-initializing" | "sdk-initialized" | "creating";
...
async function getFHEVMRelayerMetadata(rpcUrl: string) {
  ...
  try {
    ...
    throwFhevmError("FHEVM_RELAYER_METADATA_ERROR", `The URL ${rpcUrl} is not a FHEVM Hardhat node or is not reachable.`, e);
  } finally {
    rpc.destroy();
  }
}
