...
import { GenericStringStorage } from "@/hooks/useInMemoryStorage";
...
export class FhevmDecryptionSignature {
  ...
  async saveToGenericStringStorage(storage: GenericStringStorage, instance: FhevmInstance, withPublicKey: boolean) {
    ...
    const storageKey = new FhevmDecryptionSignatureStorageKey(instance, this.#contractAddresses, userAddress, withPublicKey ? this.#publicKey : undefined);
